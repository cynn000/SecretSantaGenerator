...
def main():
    ...
    while ?:
        ...
        # ensure each participant only appears once
        # ensure each receiver(each buyingFor) only appears once
        # ensure each participant is not buying for themselves

        # ensure Linn does not have Maddison
